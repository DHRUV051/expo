...
const EditStudentCreateForm = ({ rowData }) => {
  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_NGROK_API}/student/${rowData.u_id}`, {
          headers: {
  ...
  const onSubmit = async data => {
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_NGROK_API}/student`, data, {
